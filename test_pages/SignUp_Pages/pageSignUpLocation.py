...
class SignUpLocation(BasePage):
    ...
    def fill_fields(self):
        ...
        action.perform()
        print ('7) state1: %s'%self.driver.find_element(*SigninPageLocators.location_signUp_state2).get_attribute('value'))
        locationInfo['state1'] = self.driver.find_element(*SigninPageLocators.location_signUp_state2).get_attribute('value')
