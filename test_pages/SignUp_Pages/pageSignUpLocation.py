...
class SignUpLocation(BasePage):
    ...
    def fill_fields(self):
        ...
        print ('1) name2: %s'%loc_name1.get_attribute('value'))
        locationInfo['name2'] = loc_name1.get_attribute('value')

        loc_email1 = self.driver.find_element(
            *SigninPageLocators.location_signUp_email1)
        loc_email1.send_keys(fake.email())
        print ('2) email2: %s'%loc_email1.get_attribute('value'))
        locationInfo['email2'] = loc_email1.get_attribute('value')

        loc_ph1 = self.driver.find_element(
            *SigninPageLocators.location_signUp_phn1)
        loc_ph1.send_keys("12345678904")
        print ('3) phone no2: %s'%loc_ph1.get_attribute('value'))
        locationInfo['phone_no2'] = loc_ph1.get_attribute('value')
        ...
        print ('4) name1: %s'%loc_name2.get_attribute('value'))
        locationInfo['name1'] = loc_name2.get_attribute('value')
        ...
        loc_street2.send_keys(fake.building_number() +
                              " " + fake.street_name())
        print ('5) street1: %s'%loc_street2.get_attribute('value'))
        locationInfo['street1'] = loc_street2.get_attribute('value')

        loc_city2 = self.driver.find_element(
            *SigninPageLocators.location_signUp_city2)
        loc_city2.send_keys(fake.city())
        print ('6) city1: %s'%loc_city2.get_attribute('value'))
        locationInfo['city1'] = loc_city2.get_attribute('value')
        ...
        loc_street1.send_keys(fake.building_number() +
                              " " + fake.street_name())
        print ('8) street2: %s'%loc_street1.get_attribute('value'))
        locationInfo['street2'] = loc_street1.get_attribute('value')

        loc_city1 = self.driver.find_element(
            *SigninPageLocators.location_signUp_city1)
        loc_city1.send_keys(fake.city())
        print ('9) city2: %s'%loc_city1.get_attribute('value'))
        locationInfo['city2'] = loc_city1.get_attribute('value')
        ...
        print ('11)post_code2: %s'%loc_post_code1.get_attribute('value'))
        locationInfo['post_code2'] = loc_post_code1.get_attribute('value')

        loc_other_phn1.clear()
        loc_other_phn1.send_keys("12345678905")
        print ('12)other_phone no2: %s'%loc_other_phn1.get_attribute('value'))
        locationInfo['other_phone_no2'] = loc_other_phn1.get_attribute('value')
        ...
        print ('13)post_code1: %s'%loc_post_code2.get_attribute('value'))
        locationInfo['post_code1'] = loc_post_code2.get_attribute('value')

        loc_email2.clear()
        loc_email2.send_keys(fake.email())
        print ('14) email1: %s'%loc_email2.get_attribute('value'))
        locationInfo['email1'] = loc_email2.get_attribute('value')

        loc_phn2.clear()
        loc_phn2.send_keys("12345678906")
        print ('15) phone_no1: %s'%loc_phn2.get_attribute('value'))
        locationInfo['phone_no1'] = loc_phn2.get_attribute('value')
        print (locationInfo)
        # Modal
