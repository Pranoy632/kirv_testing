...
class SupplierCustomers(BasePage):
            ...
            for input_value in value['invalid']:
                if 'state' in key:
                    if 'Ship' in str(edit):
                        ...
                        self.get_page_body().send_keys(Keys.UP)
                    self.close_chat_popup_while_button_click(self.get_element(value['input']))
                    time.sleep(1)
                ...
                if (key == 'account_no' or key == 'other_phone_no') and input_value == '':
                    ...
                    try:
                        assert 'has-danger' in self.get_element(value['error']).get_attribute('class').split()
    ...
    def check_pending_customer_company_detail(self):
        ...
        try:
            ...
            self.close_chat_popup_while_button_click(self.get_element(SupplierPageLocators.edit_company_information))
        ...
        self.close_chat_popup_while_button_click(self.get_element(SupplierPageLocators.company_cancel_button))
    ...
    def check_edited_pending_customer_company_detail(self):
        ...
        self.close_chat_popup_while_button_click(self.get_element(SupplierPageLocators.edit_company_information))
        time.sleep(2)
        self.check_invalid_input(companyInfo_testcase_input, SupplierPageLocators.company_save_button, SupplierPageLocators.edit_company_information)
        ...
        for key, value in companyInfo_testcase_input.items():
            for input_value in value['valid']:
                self.close_chat_popup_while_button_click(self.get_element(SupplierPageLocators.edit_company_information))
                self.check_valid_input(key, value['input'], input_value, SupplierPageLocators.company_save_button)
                if key == 'company_name':
    ...
    def check_pending_customer_contact_detail(self):
        ...
        """
        self.close_chat_popup_while_button_click(self.get_element(SupplierPageLocators.edit_contact_information))
        try:
        ...
        self.close_chat_popup_while_button_click(self.get_element(SupplierPageLocators.contact_cancel_button))
    ...
    def check_edited_pending_customer_contact_detail(self):
        ...
        try:
            ...
            self.check_invalid_input(contactInfo_testcase_input, SupplierPageLocators.contact_save_button, SupplierPageLocators.edit_contact_information)
        except:
            self.close_chat_popup()
            self.get_element(SupplierPageLocators.edit_contact_information).click()
            self.check_invalid_input(contactInfo_testcase_input, SupplierPageLocators.contact_save_button, SupplierPageLocators.edit_contact_information)
        ...
        for key, value in contactInfo_testcase_input.items():
            for input_value in value['valid']:
                self.close_chat_popup_while_button_click(self.get_element(SupplierPageLocators.edit_contact_information))
                self.check_valid_input(key, value['input'], input_value, SupplierPageLocators.contact_save_button)
                if key == 'email':
    ...
    def check_pending_customer_location_detail(self):
        ...
        try:
            ...
            print (repr(error))
        time.sleep(1)
        self.close_chat_popup_while_button_click(self.get_element(SupplierPageLocators.location_cancel_button))
        self.page_up()
    ...
    def check_edited_pending_customer_location_detail(self):
        ...
        time.sleep(1)
        self.page_down()
        self.check_invalid_input(locationInfo_testcase_input, SupplierPageLocators.location_save_button, SupplierPageLocators.edit_location_information)
        self.close_chat_popup_while_button_click(self.get_element(SupplierPageLocators.location_cancel_button))
        self.page_up()
        ...
        for key, value in locationInfo_testcase_input.items():
            for input_value in value['valid']:
                ...
                time.sleep(1)
                self.page_down()
                self.check_valid_input(key, value['input'], input_value, SupplierPageLocators.location_save_button)
    ...
    def check_pending_customer_shipping_detail(self):
        ...
        assert self.get_element(SupplierPageLocators.ship_start_time1_input).get_attribute('value') == shippingInfo['start_time1']
        assert self.get_element(SupplierPageLocators.ship_end_time1_input).get_attribute('value') == shippingInfo['end_time1']
        assert self.get_element(SupplierPageLocators.ship_name2_input).get_attribute('value') == shippingInfo['name2']
        assert self.get_element(SupplierPageLocators.ship_address2_input).get_attribute('value') == shippingInfo['street2']
        assert self.get_element(SupplierPageLocators.ship_city2_input).get_attribute('value') == shippingInfo['city2']
        assert self.get_element(SupplierPageLocators.ship_state2_input).get_attribute('value').lower() == shippingInfo['state2'].lower()
        assert self.get_element(SupplierPageLocators.ship_post_code2_input).get_attribute('value') == shippingInfo['post_code2']
        assert self.get_element(SupplierPageLocators.ship_email2_input).get_attribute('value') == shippingInfo['email2']
        assert self.get_element(SupplierPageLocators.ship_phone2_input).get_attribute('value') == shippingInfo['phone_no2'] if shippingInfo['phone_no2'][0] == '+' else '+' + shippingInfo['phone_no2']
        assert self.get_element(SupplierPageLocators.ship_start_time2_input).get_attribute('value') == shippingInfo['start_time2']
        assert self.get_element(SupplierPageLocators.ship_end_time2_input).get_attribute('value') == shippingInfo['end_time2']
        #except Exception as error:
