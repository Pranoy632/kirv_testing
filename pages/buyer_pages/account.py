...
from locators.buyer_locators.account_locator import AccountLocators, AccountInnerLocators
...
class Account(BasePage):
    ...
    def full_name_error(self):
        return self.driver.find_element(
            *AccountInnerLocators.full_name_err).is_displayed()

    def email_error(self):
        return self.driver.find_element(
            *AccountInnerLocators.email_err).is_displayed()

    def phone_error(self):
        return self.driver.find_element(
            *AccountInnerLocators.phone_err).is_displayed()

    def other_phone_error(self):
        return self.driver.find_element(
            *AccountInnerLocators.other_phn_err).is_displayed()
    ...
    def check_title_in_account(self):
        self.wait_for_element(AccountInnerLocators.my_account_title)
        title = self.driver.find_element(
            *AccountInnerLocators.my_account_title)
        try:
    ...
    def sub_navbar_list(self):
        self.wait_for_element(AccountInnerLocators.sub_navbar_link)
        navbar_sub = self.driver.find_element(
            *AccountInnerLocators.sub_navbar_link)
    ...
    def check_title_on_user_profile(self):
        self.wait_for_element(AccountInnerLocators.customer_profile_title)
        title = self.driver.find_element(
            *AccountInnerLocators.customer_profile_title)
        try:
            assert title.is_displayed() == True
            print("Success: %s title found." % (title.text))
        except:
    ...
    def customer_profile_edit_btn(self):
        self.wait_for_element(AccountInnerLocators.customer_pro_edit_btn)
        self.driver.find_element(
            *AccountInnerLocators.customer_pro_edit_btn).click()

    def customer_profile_save_btn(self):
        self.wait_for_element(AccountInnerLocators.cust_pro_save_btn)
        save = self.driver.find_element(
            *AccountInnerLocators.cust_pro_save_btn)
        save.click()

    def customer_profile_cancel_btn(self):
        self.wait_for_element(AccountInnerLocators.cust_pro_cancel_btn)
        cancel = self.driver.find_element(
            *AccountInnerLocators.cust_pro_cancel_btn)
        cancel.click()
    ...
    def check_fields(self):
        ...
        self.clear_put_value(AccountInnerLocators.full_name)
        ...
        time.sleep(1)
        self.driver.find_element(
            *AccountInnerLocators.full_name).send_keys('Test')
        self.customer_profile_save_btn()

        # Email
        self.customer_profile_edit_btn()
        self.clear_put_value(AccountInnerLocators.email)
        self.customer_profile_save_btn()
        try:
        ...
        time.sleep(1)
        self.driver.find_element(
            *AccountInnerLocators.email).send_keys('Test@')
        self.customer_profile_save_btn()
        try:
            assert self.email_error() == True
        ...
        self.clear_put_value(AccountInnerLocators.email)
        self.driver.find_element(
            *AccountInnerLocators.email).send_keys('shashank.n@amazatic.com')
        self.customer_profile_save_btn()

        # phone
        self.customer_profile_edit_btn()
        self.clear_put_value(AccountInnerLocators.phone)
        self.customer_profile_save_btn()
        try:
        ...
        time.sleep(1)
        self.driver.find_element(
            *AccountInnerLocators.phone).send_keys('5566')
        self.customer_profile_save_btn()
        try:
            assert self.phone_error() == True
        ...
        self.clear_put_value(AccountInnerLocators.phone)
        self.driver.find_element(
            *AccountInnerLocators.phone).send_keys('+12102102101')
        self.customer_profile_save_btn()

        # other-phone
        self.customer_profile_edit_btn()
        self.clear_put_value(AccountInnerLocators.other_phone)
        self.driver.find_element(
            *AccountInnerLocators.other_phone).send_keys('5566')
        self.customer_profile_save_btn()
        try:
